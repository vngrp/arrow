...
class EffectSpec {
  ...
  @Test fun recoverPlusCatchRaiseAndRecover() = runTest {
    checkAll(Arb.int().suspend(), Arb.long().suspend()) { i, l ->
      effect<String, Int> {
        effect<Long, Int> {
          raise(l())
  ...
  @Test fun recoverPlusCatchRaiseAndTransformError() = runTest {
  ...
  @Test fun recoverPlusCatchThrowAndRecover() = runTest {
  ...
  @Test fun recoverPlusCatchThrowAndTransformError() = runTest {
  ...
  @Test fun recoverPlusCatchRaiseAndThrow() = runTest {
    checkAll(Arb.long().suspend(), Arb.string().suspend()) { l, s ->
      effect<String, Int> {
        effect<Long, Int> {
          raise(l())
  ...
  @Test fun recoverPlusCatchThrowAndThrow() = runTest {
  ...
  @Test fun recoverPlusCatchSuccess() = runTest {
    checkAll(Arb.int().suspend(), Arb.long().suspend()) { i, l ->
      effect<String, Int> {
        effect<Long, Int> { i() }
